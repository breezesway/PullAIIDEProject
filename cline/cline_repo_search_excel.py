...
class GitHubSearch:
    ...
    def _save_search_results(self, search_type: str, repos_dict: Dict[str, Dict], timestamp: str = None) -> None:
        ...
        excel_filename = os.path.join(self.output_dir, f'cline_{search_type}_{timestamp}.xlsx')
    ...
    def save_results(self) -> None:
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = os.path.join(self.output_dir, f'cline_all_repositories_{timestamp}.xlsx')
...
def main():
    ...
    print("Starting search for Cline-related repositories...")
    
    # Search repositories by description
    searcher.search_repositories_by_description("Cline")
