...
class GitHubSearch:
    ...
    def _save_search_results(self, search_type: str, repos_dict: Dict[str, Dict], timestamp: str = None) -> None:
        ...
        csv_filename = os.path.join(self.output_dir, f'cursor_{search_type}_{timestamp}.csv')
    ...
    def search_cursor_files(self, is_current_search: bool = True) -> None:
        """Search for repositories containing Cursor files."""
        cursor_files = [
            "path:.cursor extension:mdc",
        ...
        for file_name in cursor_files:
            ...
            for item in data['items']:
                self._add_repository(item, f"cursor_config: {file_name}", is_current_search)
    ...
    def save_results(self) -> None:
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        csv_filename = os.path.join(self.output_dir, f'cursor_all_repositories_{timestamp}.csv')
...
def main():
    ...
    cursor_keywords = [
        ...
        "Cursor suggestion",
        "applied Cursor edit",
        "auto refactor by Cursor",
        "refactored with Cursor",
        "Cursor-assisted change",
        "accept suggestion from Cursor",
        "used Cursor for this part",
        "Generated using Anysphere Cursor",
        "Auto-generated with Cursor AI"
    ]
    ...
    print("Starting search for Cursor-related repositories...")
    
    # Search repositories by description
    searcher.search_repositories_by_description("Cursor")
    ...
    # Search for Cursor configuration files
    searcher.search_cursor_files()
    searcher._save_search_results("cursor_files", searcher.current_search_repos)
    searcher.current_search_repos.clear()
