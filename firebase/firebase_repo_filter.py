...
def filter_csv_by_keywords():
    ...
    keywords = [
        "Firebase IDE", "Firebase AI", 
        "using Firebase", "Firebase Agent", "use Firebase", "with Firebase", "by Firebase", "in Firebase", "through Firebase", "via Firebase",
        "claude", "sonnet 3.7", "deepseek", 
        "制作", "实现", "编写", "生成", "创建", "开发", 
        "built", "build", 
        "基于Firebase", "通过Firebase", "借助Firebase", "用firebase", "由firebase"
        "using Project IDX", "Project IDX Agent", "use Project IDX", "with Project IDX", "by Project IDX", "in Project IDX", "through Project IDX", "via Project IDX",
    ]
    
    # Define the exclusion keywords
    exclusion_keywords = [
        "test", "demo", "learn", "practice", "practical", "rule", "rules", "mouse", "pagination", 
        "a firebase", "重置", "无限试用", "curse", "3D firebase", "your firebase", 
        "custom firebase", "教程", "firebase navigation", "navigation", "firebase move", "学习", 
        ...
        "oracle", "store procedure", "mysql", "sql server", "firebase library", "Drawing", "draw", 
        "prompt", "collection", "hand gesture", "canvas", "click", "firebase array", "SQL", 
        "experiment", "scrollbar", "Portfolio", "template", "course", "tutorial", "toy", "玩具", 
        "实验", "live firebase", "guideline", "quiz", "small", "exploring", "realtime", "real-time"
    ]
    ...
    input_file = os.path.join(script_dir, "firebase_all_repo.xlsx")
    
    # Check if the file exists
    if not os.path.exists(input_file):
        print(f"Error: File 'filtered_firebase_repo.xlsx' not found!")
