...
class GitHubSearch:
    ...
    def _save_search_results(self, search_type: str, repos_dict: Dict[str, Dict], timestamp: str = None) -> None:
        ...
        csv_filename = os.path.join(self.output_dir, f'windsurf_{search_type}_{timestamp}.csv')
    ...
    def search_windsurf_files(self, is_current_search: bool = True) -> None:
        """Search for repositories containing Windsurf files."""
        windsurf_files = [
            "path:.windsurf",
            "filename:.windsurfrules",
            "filename:.codeiumignore",
            "filename:.codeiumindexingignore"
        ]
        ...
        for file_name in windsurf_files:
            ...
            for item in data['items']:
                self._add_repository(item, f"windsurf_config: {file_name}", is_current_search)
    ...
    def save_results(self) -> None:
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        csv_filename = os.path.join(self.output_dir, f'windsurf_all_repositories_{timestamp}.csv')
...
def main():
    ...
    # Windsurf-related keywords
    windsurf_keywords = [
        "generated by Windsurf",
        "edited using Windsurf",
        "developed with Windsurf",
        "powered by Windsurf",
        "AI coding with Windsurf",
        "Windsurf suggestion",
        "applied Windsurf edit",
        "auto refactor by Windsurf",
        "refactored with Windsurf",
        "Windsurf-assisted change",
        "accept suggestion from Windsurf",
        "used Windsurf for this part",
        "Generated using Anysphere Windsurf",
        "Auto-generated with Windsurf AI"
    ]
    ...
    for keyword in windsurf_keywords:
    ...
    # Search for Windsurf configuration files
    searcher.search_windsurf_files()
    searcher._save_search_results("windsurf_files", searcher.current_search_repos)
    searcher.current_search_repos.clear()
